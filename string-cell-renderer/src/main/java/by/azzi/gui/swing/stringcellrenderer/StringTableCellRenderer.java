 ...
 * @author Ihar Misevih
 */
public class StringTableCellRenderer<E> extends JLabel implements TableCellRenderer, Serializable {
    ...
    private final CellRendererStringConverter<E> converter;

    /**
     * Creates a default table cell renderer.
     */
    public StringTableCellRenderer(CellRendererStringConverter<E> converter) {
        super();
    ...
    protected void setValue(Object value) {
        setText(value != null ? converter.convert((E) value) : converter.nullConvert());
    }
}
